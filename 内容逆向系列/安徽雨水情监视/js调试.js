    ...
    base64encode: function(str) {
        ...
        while (i < len) {
            ...
            if (i == len) {
                ...
                out.push(this.base64EncodeChars.charAt((c1 & 3) << 4));
                out.push("\x3d\x3d");
                break
            }
            c2 = str.charCodeAt(i++);
            if (i == len) {
                out.push(this.base64EncodeChars.charAt(c1 >> 2));
                out.push(this.base64EncodeChars.charAt((c1 & 3) << 4 | (c2 & 240) >> 4));
                out.push(this.base64EncodeChars.charAt((c2 & 15) << 2));
                out.push("\x3d");
                break
            }
            c3 = str.charCodeAt(i++);
            out.push(this.base64EncodeChars.charAt(c1 >> 2));
            out.push(this.base64EncodeChars.charAt((c1 & 3) << 4 | (c2 & 240) >> 4));
            out.push(this.base64EncodeChars.charAt((c2 & 15) << 2 | (c3 & 192) >> 6));
            out.push(this.base64EncodeChars.charAt(c3 & 63))
        }
        return out.join("")
    },
    base64decode: function(str) {
        ...
        while (i < len) {
            ...
            while (i < len && c2 == -1);if (c2 == -1)
                break;
            out.push(String.fromCharCode(c1 << 2 | (c2 & 48) >> 4));
            do {
                ...
                break;
            out.push(String.fromCharCode((c2 & 15) << 4 | (c3 & 60) >> 2));
            do {
                ...
                break;
            out.push(String.fromCharCode((c3 & 3) << 6 | c4))
        }
        return out.join("")
    },
    ...
    utf8to16: function(str) {
        ...
        while (i < len) {
            ...
            case 13:
                ...
                out.push(String.fromCharCode((c & 31) << 6 | char2 & 63));
                break;
            case 14:
                char2 = str.charCodeAt(i++);
                char3 = str.charCodeAt(i++);
                out.push(String.fromCharCode((c & 15) << 12 | (char2 & 63) << 6 | (char3 & 63) << 0));
                break
            }
        }
        return out.join("")
...
function encode() {
    var  waterEncode = waterSecurity.encode("true");
	return waterEncode;
};
function decode(data) {
    var a = waterSecurity.decode(data);
    return a;
};
