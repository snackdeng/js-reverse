...
!function(e) {
    ...
    this.atob = base64decode,
        this.btoa = base64encode;
}(this);



window.b_u = function (base64String) {
...
function xx (data){
    var data1 =  window.b_u(data);
    var _440 = window.snackdeng(440);
    var _457 = window.snackdeng(457);
...
window.b_u = function base64ToUint8Array(base64String) {
    let padding = '='.repeat((4 - base64String.length % 4) % 4);
    let base64 = (base64String + padding)
        .replace(/\-/g, '+')
        .replace(/_/g, '/');
...
console.log(xx(""))