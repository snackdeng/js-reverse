...
// @time: 2020-08-03 15:46:57
// -->

function getpwd(n, l, e) {
        function d(n, l) {
        ...
        function a(n, l) {
            ...
            for (e = 0; e < n.length; e += 16)
                r = p(t = r, u = a, i = s, o = c, n[e], 7, -680876936),
        ...
        function s(n) {
            ...
            for (l = 0; l < 32 * n.length; l += 8)
                e += String.fromCharCode(n[l >> 5] >>> l % 32 & 255);
            return e
        }
        ...
        function c(n) {
            ...
            for (l = 0; l < 8 * n.length; l += 8)
                e[l >> 5] |= (255 & n.charCodeAt(l / 8)) << l % 32;
            return e
        }
